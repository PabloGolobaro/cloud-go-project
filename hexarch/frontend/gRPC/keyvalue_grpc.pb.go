...
type KeyValueClient interface {
	...
	Put(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*PutResponce, error)
...
func (c *keyValueClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponce, error) {
	out := new(GetResponce)
...
func (c *keyValueClient) Put(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*PutResponce, error) {
	out := new(PutResponce)
...
func (c *keyValueClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponce, error) {
...
type KeyValueServer interface {
	...
	Put(context.Context, *PutRequest) (*PutResponce, error)
...
func (UnimplementedKeyValueServer) Get(context.Context, *GetRequest) (*GetResponce, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedKeyValueServer) Put(context.Context, *PutRequest) (*PutResponce, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Put not implemented")
}
func (UnimplementedKeyValueServer) Delete(context.Context, *DeleteRequest) (*DeleteResponce, error) {
